...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const detectIntent = (text) => {
    ...
    // Mapeamento de palavras-chave para respostas (GIGANTE)
    const patterns = [
      // ==========================================
      // 1. SMALL TALK, IDENTIDADE E GÍRIAS
      // ==========================================
      { keys: ['tlgd', 'pdp', 'pdc', 'fmz', 'blz', 'vlw', 'obg', 'slc', 'slk', 'daora', 'maneiro', 'top', 'brabo', 'irado', 'pode pa', 'suave', 'tranquilo'], response: {
      ...
      { keys: ['q', 'que', 'como assim', 'nao entendi', 'hahn', 'hein', 'que isso', 'wat'], response: {
      ...
      { keys: ['burro', 'burra', 'inutil', 'odeio', 'chato', 'merda', 'lixo', 'porcaria', 'droga', 'foda', 'puta'], response: {
      ...
      // ==========================================
      // 4. URGÊNCIAS E SINTOMAS (GATILHOS CLÍNICOS)
      // ==========================================
      ...
      // ==========================================
      // 5. ESTÉTICA, PROCEDIMENTOS E DÚVIDAS ESPECÍFICAS
      // ==========================================
